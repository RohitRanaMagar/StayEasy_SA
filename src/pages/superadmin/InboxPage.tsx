...
import {
  Mail, MailOpen, Trash2, Circle, MessageSquare,
} from 'lucide-react'
      ...
      <PageTransition>
        <div className="max-w-3xl">
          <div className="bg-white rounded-xl border border-gray-100 p-12 text-center">
            ...
            <p className="text-xs text-gray-300 mt-2">WhatsApp & Telegram integration coming soon</p>
          </div>
        </div>
      </PageTransition>
    )
        ...
        {selectedMessage ? (
          <div className="flex-1 bg-white rounded-xl border border-gray-100 overflow-hidden flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 shrink-0">
              <div>
                <h3 className="text-[14px] font-bold text-gray-900">{selectedMessage.subject}</h3>
                <p className="text-[11px] text-gray-400 mt-0.5">
                  From: <span className="text-gray-600">{selectedMessage.sender}</span> · {selectedMessage.timestamp}
                </p>
              </div>
              <div className="flex items-center gap-2">
                <button
            ...
            <div className="flex-1 overflow-y-auto p-6">
              <p className="text-[13px] text-gray-700 leading-relaxed whitespace-pre-wrap">
                ...
                {'\n\n'}This is a preview of the full message. In a real implementation, this would contain the complete email or chat content from WhatsApp/Telegram integration.
              </p>
            </div>
            <div className="px-6 py-3 border-t border-gray-100 flex items-center justify-between shrink-0">
              <span className="text-[10px] text-gray-300">WhatsApp & Telegram integration coming soon</span>
          ...
          <div className="flex-1 bg-white rounded-xl border border-gray-100 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-[13px] text-gray-400">Select a message to read</p>
            </div>
          </div>
        )}
      </div>
