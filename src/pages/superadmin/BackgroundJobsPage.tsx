...
const jobQueues: JobQueue[] = mockJobQueues
const jobEntries: JobEntry[] = mockJobEntries
const scheduledTasks: ScheduledTask[] = mockScheduledTasks
const workerPools: WorkerPool[] = mockWorkerPools
