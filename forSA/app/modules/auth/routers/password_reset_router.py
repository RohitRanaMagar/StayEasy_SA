...
from app.middlewares.auth_middlewares import CurrentGuest, CurrentUser, CurrentSuperAdmin
...
async def change_superadmin_password(
    ...
    await password_reset_service.change_password(
        current_superadmin, payload.current_password, payload.new_password, "superadmin"
    )
    return StandardResponse(
        success=True,
        data="Password changed successfully.You can now log in with your new password.",
